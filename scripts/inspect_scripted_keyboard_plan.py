...
def main() -> int:
    ...
    print(f"Uses Cont. Grip    : {summary['uses_continuous_grip']}")
    print(f"Min Grip Fraction  : {summary['min_grip_fraction']}")
    print(f"Max Grip Fraction  : {summary['max_grip_fraction']}")
    ...
    if summary["total_ticks"] > 0:
        ...
        print(f"  Grip Fraction     : {first_command.grip_fraction}")
        print(f"  Grip Close Speed  : {first_command.grip_close_speed}")
        ...
        print(f"  Grip Fraction     : {last_command.grip_fraction}")
        print(f"  Grip Close Speed  : {last_command.grip_close_speed}")
